...
class Query {
    ...
    */
    public List<Integer> queryToHashList(String queryString, HashMap<String, String> extraFilter) {
        ...
        while(attrMapIterator.hasNext() && tokenCount>0) {
            ...
            String attr = (String) pair.getKey();
            HashMap<String, Integer> valueMap = (HashMap<String, Integer>) pair.getValue();
